<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" CodeFile="edit_course.aspx.cs" Inherits="admin_edit_course" %>
                         ...
                         <header class="w3-container w3-purple">
                           ...
                           <div class="w3-container" align="center"><br />
                            a
                                   ...
                                   <div align="center">
                                            <asp:Button ID="update"  runat="server" Text="Update Course" class="btn btn-warning btn-warng1"  onclick="update_Click" />
                                    </div>
                                    <br/>
                         </div>
                  </div>
