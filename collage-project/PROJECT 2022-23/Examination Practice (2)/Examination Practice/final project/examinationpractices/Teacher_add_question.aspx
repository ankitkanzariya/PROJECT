<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeFile="Teacher_add_question.aspx.cs" Inherits="Teacher_Teacher_add_question" %>
                         ...
                         <header class="w3-container w3-yellow">
                           ...
                           <table>
                            ...
                            <label>Semester :  </label><br />
                                <asp:DropDownList ID="DropDownListsem" class="btn btn-default dropdown-toggle" runat="server" Width="200px"  Height="40px" onselectedindexchanged="DropDownListsem_SelectedIndexChanged" AutoPostBack="True" >
                                <asp:ListItem Value="--- Select ---"></asp:ListItem></asp:DropDownList><br/>
                            ...
                            <label>Subjects :  </label><br />
                                <asp:DropDownList ID="DropDownListsub" class="btn btn-default dropdown-toggle" runat="server" Height="40px" Width="200px">
                                 <asp:ListItem Value="--- Select ---"></asp:ListItem></asp:DropDownList><br/>
